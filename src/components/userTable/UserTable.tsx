          ...
          <table className="min-w-max w-full table-auto">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                <th className="py-3 px-6 w-10 text-left">Email</th>
                <th className="py-3 px-6 w-96 text-left">Full Name</th>
                <th className="py-3 px-6 w-10 text-center">Pseudo</th>
                <th className="py-3 px-6 w-10 text-center">Is Active</th>
